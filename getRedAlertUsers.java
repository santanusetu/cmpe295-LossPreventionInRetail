...
@Path("/getRedAlertUsers")
public class RedAlertUserIndicator {
	@GET
	...
	public static String show() throws Exception
	{
		...
		while(rs.next())
		{
			sb.append("Users who lost the packages: "+rs.getString(3)+"\n");	
			sb.append("Destination address: "+rs.getString(9)+"\n");
		}
		return sb.toString();
